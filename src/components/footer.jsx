      ...
      <div className="footer__container">
        <ul className="footer__box container">
          <li className="footer__box__left">
            ...
            />
            <p className="footer__box__left__text">
            ...
            <ul className="footer__box__left__link">
              <li className="footer__box__left__link__facebook">
                <svg
                  ...
                  fill="white"
                  opacity="0.6"
                  className="footer__box__left__link__facebook--white footer__box__left__link--hover"
                >
              ...
              <li className="footer__box__left__link__twitter">
                <svg
                  width="20"
                  height="20"
                  className="footer__box__left__link__twitter--white footer__box__left__link--hover"
                  fill="white"
                  opacity="0.6"
                >
              ...
              <li className="footer__box__left__link__youtube">
                <svg
                  width="20"
                  height="20"
                  className="footer__box__left__link__youtube--white footer__box__left__link--hover"
                  fill="white"
                  opacity="0.6"
                >
              ...
              <li className="footer__box__left__link__telegram">
                <svg
                  width="20"
                  height="20"
                  className="footer__box__left__link__telegram--white footer__box__left__link--hover"
                  fill="white"
                  opacity="0.6"
                >
              ...
              <li className="footer__box__left__link__instagram">
                <svg
                  width="20"
                  height="20"
                  className="footer__box__left__link__instagram--white footer__box__left__link--hover"
                  fill="white"
                  opacity="0.6"
                >
              ...
              <li className="footer__box__left__link__linkedin">
                <svg
                  width="20"
                  height="20"
                  className="footer__box__left__link__linkedin--white footer__box__left__link--hover"
                  fill="white"
                  opacity="0.6"
                >
          ...
          <li className="footer__box__center">
            <div className="footer__box__center__sitemap">
              ...
              <ul className="footer__box__center__sitemap__list">
                <li
                  className="footer__box__center__box__sitemap__aboutus footer--gray list__item"
                  onClick={() => {
                    navigate("/about");
                    window.scrollTo({ top: 0 });
                  }}
                ...
                <li
                  className="footer__box__center__box__sitemap__courses footer--gray list__item"
                  onClick={() => {
                    navigate("/courses");
                    window.scrollTo({ top: 0 });
                  }}
                ...
                <li
                  className="footer__box__center__box__sitemap__events footer--gray list__item"
                  onClick={() => {
                    navigate("/events");
                    window.scrollTo({ top: 0 });
                  }}
                ...
                <li
                  className="footer__box__center__box__sitemap__blog footer--gray list__item"
                  onClick={() => {
                    navigate("/blogs");
                    window.scrollTo({ top: 0 });
                  }}
                ...
                <li
                  className="footer__box__center__box__sitemap__contacts footer--gray list__item"
                  onClick={() => {
                    navigate("/contacts");
                    window.scrollTo({ top: 0 });
                  }}
            ...
            <div className="footer__box__center__courses">
              ...
              <ul className="footer__box__center__courses__list">
                <li
                  className="footer__box__center__courses__marketing footer--gray list__item"
                  onClick={(e) => {
                    navigate("/courses", { state: e.target.innerText });
                    window.scrollTo({ top: 0 });
                  }}
                >
                  Marketing
                ...
                <li
                  className="footer__box__center__courses__management footer--gray list__item"
                  onClick={(e) => {
                    navigate("/courses", { state: e.target.innerText });
                    window.scrollTo({ top: 0 });
                  }}
                ...
                <li
                  className="footer__box__center__courses__hr footer--gray list__item"
                  onClick={(e) => {
                    navigate("/courses", { state: e.target.innerText });
                    window.scrollTo({ top: 0 });
                  }}
                ...
                <li
                  className="footer__box__center__courses__design footer--gray list__item"
                  onClick={(e) => {
                    navigate("/courses", { state: e.target.innerText });
                    window.scrollTo({ top: 0 });
                  }}
                ...
                <li
                  className="footer__box__center__courses__development footer--gray list__item"
                  onClick={(e) => {
                    navigate("/courses", { state: e.target.innerText });
                    window.scrollTo({ top: 0 });
                  }}
              ...
              <ul className="footer__box__center__contactus">
                <li className="footer__box__center__contactus__tel footer--gray list__item">
                  <svg width="20" height="20">
                    <use
                      href={`${UserSvg}#icon-iPhone`}
                      className="footer__box__left__link__facebook--white"
                    />
                  </svg>
          ...
          <li className="footer__box__right">
            <h3 className="footer__box__right__title">
              SIGN UP TOOUR NEWSLETTER
            </h3>
            <form className="footer__box__right__form">
              <input
                className="footer__box__right__input"
                placeholder="Email address"
              ></input>
              <svg
                width="16"
                height="16"
                className="footer__box__right__input__svg"
              >
                <use href={`${UserSvg}#icon-Right`}></use>
              </svg>
            </form>
            <p className="footer__box__right__warning">
          ...
          <div className="footer__bottom__container container">
            <div className="footer__copyright ">
              <span>
                ...
                <svg width="16" height="16" className="footer__copyright__svg">
