  ...
  return (
    <div className="curator-section">
      <div className="container curator-container">
        <img
          src={state.course.profilePicture}
          alt="curator"
          width="590"
        ...
        <div className="curator-info__wrap">
          <h2 className="about-title">
            Course curator
            <br />
            <span className="about-title__span">{state.course.aboutName}</span>
          </h2>
          <p className="curator-info__title">{state.course.aboutJobTitle}</p>
          ...
          <ul className="curator-info__list">
            <li className="curator-info__list__item">
              ...
              <p>{state.course.rate}</p>
            </li>
            <li className="curator-info__list__item">
              <svg width="20" height="20">
                <use href={`${Svg}#icon-play`} />
              </svg>
              <p>{state.course.countCourses}</p>
            </li>
            <li className="curator-info__list__item">
              <svg width="20" height="20">
                <use href={`${Svg}#icon-profile`} />
              </svg>
              <p>{state.course.countStudents}</p>
            </li>
          </ul>
